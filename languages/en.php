...
To remove a widget drag it back to the <b>Widget gallery</b>.",
		 ...
		 */
			...
			'admin:plugins:re-enable:yes' => "Plugin %s was re-enabled successfully.",
			'admin:plugins:re-enable:no' => "Plugin %s could not be re-enabled.",
...
You cannot reply to this email.",
		 ...
		 */
			...
			'taguser:wallpost:title' => 'You has been tagged at <a href="%s">Here</a>',
			'taguser:sysnotify:exits' =>' This user has been tagged',
