<?php
    ...
    //		echo "<pre>"; print_r($annotations);die;
  		...
  		foreach($group_array as $contents) {
			...
			echo "<h2><b>Group: ".get_entity(KeyName($group_array,$pos))->name."</b></h2>";
  		...
  		//	echo get_entity(KeyName($group_array,$pos))->name;
  			...
  			foreach($contents as $content)
				{
				echo elgg_view("testimonate/group", array('annotation' => $content));
				}
		...
		//	echo "Friend";
			...
			echo elgg_view("testimonate/friend", array('annotation' =>$annotation));
