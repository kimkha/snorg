        ...
        if ( $priorVote !== false ) {
          ...
          // show the user's vote
				//	echo "<p><h2>" . elgg_echo('poll:voted') . "</h2></p>";
					...
					echo "<b>You Has Voted In This Poll<b>";
				//	echo elgg_view('poll/results',array('entity' => $vars['entity']));
				//	echo '<div id="resultsDiv" class="poll_post_body" style="display:none;">';
			// echo elgg_view('poll/results',array('entity' => $vars['entity'])); 
//echo '</div>';
    ...
    <?php if ( ($alreadyVoted) || ($vars['entity']->canEdit()) ) { ?>
		...
		<div id="resultsDiv" class="poll_post_body" >
