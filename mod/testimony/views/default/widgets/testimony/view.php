<?php
	 ...
	 */
     ...
     if(!$num_display)
        ...
        echo "<div>";
		echo sprintf(elgg_echo('messageboard:widget:title'),$entity->name);
		echo "</div>";
...
$(document).ready(function(){
    ...
    $("#postit").click(function(){
        ...
        $("#messageboard_wrapper").load("<?php echo $vars['url']; ?>mod/testimony/ajax_endpoint/load.php", {messageboard_content:$("[name=message_content]").val(), pageOwner:$("[name=pageOwner]").val(), numToDisplay:<?php echo $num_display; ?>}, function(){
...
<?php
		...
		if (!empty($contents)) {			
    		...
    		echo elgg_view('testimony/widget',array('annotation' => $contents));
