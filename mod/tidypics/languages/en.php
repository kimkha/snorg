<?php
	...
	$english = array(
		...
		//Error messages
			...
			'tag:notify:title' => "%s has tagged you in a Photo ",
			'tag:notify:content' => " Hi %s,
			%s has tagged you in his photo.
			
			You can view that photo at: http://localhost/snorg1/pg/photos/view/%s
			",
