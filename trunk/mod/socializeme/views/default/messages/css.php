...
#notificationstable td.sitetogglefield a.sitetoggleOff {
	background: url(<?php echo $vars['url']; ?>mod/web1/graphics/icon_notifications_site.gif) no-repeat right 2px;
}
#notificationstable td.sitetogglefield a.sitetoggleOn {
	background: url(<?php echo $vars['url']; ?>mod/web1/graphics/icon_notifications_site.gif) no-repeat right -36px;
}
