...
$.imgAreaSelect.init = function (img, options) {
    var $img = $(img), $area = $('<div />'),
        $border1 = $('<div />'), $border2 = $('<div />'),
        $areaOver = $('<div />'), $areaOver2,
    ...
    this.setOptions = function(newOptions)
    {
        ...
        if (options.handles) {
            for (var i = 0; i < (options.handles == 'corners' ? 4 : 8); i++)
                $handles = $handles ? $handles.add(handles[i] = $('<div />')) :
                    handles[i] = $('<div />');
        ...
        $(options.parent).append($o.add($a).add($handles));
    ...
    if ($.browser.opera)
        $areaOver.append($areaOver2 = $('<div style="width: 100%; height: 100%;" />'));
