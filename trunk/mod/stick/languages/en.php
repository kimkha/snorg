<?php
	...
	$english = array(
		...
		'stick:uremoveit' => 'Uncommend with this post',
		...
		'stick:user:emptyid' => 'Please choose the correctly commend post to edit',
		...
		'stick:user:removeerror' => 'There is an error when uncommend this user with this post',
		'stick:user:removesuccessful' => 'You uncommended with this post successful',
	);
