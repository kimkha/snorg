<?php
?>
<div id="sitenotificationDialog" title="<?php echo elgg_echo('sitenotification:title')?>" class="collapsable_box_content" style="display:none;">
...
<script type="text/javascript">
        ...
        $(function(){
				...
				$.timer(10000, function (timer) {
				  		$.getJSON("<?php echo $vars['url']; ?>query.php?action=GetNewSitenotificationCount",function(msg){
								if (msg=='0'){
                ...
                function displaySitenotifcationDialog(){
                	$('#sitenotification_bottombar').html('Not');
                	$.getJSON("<?php echo $vars['url']; ?>query.php?action=GetSitenotification&user_guid=<?php echo get_loggedin_userid() ?>", function(notifications){
