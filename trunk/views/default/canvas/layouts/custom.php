<?php
	 ...
	 */
		...
		$area1widgets = get_widgets(2,get_context(),1);
		$area2widgets = get_widgets(2,get_context(),2);
		$area3widgets = get_widgets(2,get_context(),3);
		...
		if (is_array($widgettypes) && sizeof($widgettypes) > 0 && isadminloggedin()) {
