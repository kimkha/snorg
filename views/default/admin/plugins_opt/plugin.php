...
<?php
	...
	<div class="admin_plugin_enable_disable">
		<?php if ($active) { ?>
			<a href="<?php echo $vars['url']; ?>action/admin/plugins/re-enable?plugin=<?php echo $plugin; ?>&__elgg_token=<?php echo $token; ?>&__elgg_ts=<?php echo $ts; ?>" class="reenable"><?php echo elgg_echo("re-enable"); ?></a>
